...
/**
 * @class VideoSocket
 * @brief Class that enables video streaming from the tello and creates and
 * manages the SLAM object if SLAM is enabled
 */
...
public:
   ...
   * @param [in] run reference to a bool that is set to off when the Tello
