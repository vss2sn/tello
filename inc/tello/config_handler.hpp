 ...
 * @param [in] cv_run conition variable that is notified when the code needs to
 * exit
 * @return <return_description>
 * @details <details>
 */
std::map<std::string, std::unique_ptr<Tello>>
handleConfig(const std::string &config_file, asio::io_service &io_service,
